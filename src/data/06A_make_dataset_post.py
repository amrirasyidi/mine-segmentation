...
if __name__ == '__main__':
    ...
    os.system("python src/data/04_filter_and_split_dataset.py preferred_polygons --val_ratio 0.18 --test_ratio 0.07 --only_valid_surface_mines")

    # persist images to disk
    os.system("python src/data/05_persist_pixels_masks.py data/processed/files preferred_polygons --split all")
